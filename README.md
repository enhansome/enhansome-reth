...
* [NodeDB](https://github.com/Zacholme7/NodeDB) ⭐ 43 | 🐛 0 | 🌐 Rust | 📅 2025-05-26, updates [revm](https://github.com/bluealloy/revm) ⭐ 2,221 | 🐛 83 | 🌐 Rust | 📅 2026-08-19's database directly from Reth's database
...
* [openvm-reth-benchmark](https://github.com/axiom-crypto/openvm-reth-benchmark) ⭐ 17 | 🐛 12 | 🌐 Rust | 📅 2026-08-18, a set of benchmarks for Reth within the OpenVM framework
