...
* [Repository](https://github.com/paradigmxyz/reth) ⭐ 5,770 | 🐛 249 | 🌐 Rust | 📅 2026-09-10
...
* [Sigma Prime](https://github.com/paradigmxyz/reth/blob/0a49d47dc33058cafe5d3decfce85a3a81de62f9/Sigma_Prime_Paradigm_Reth_Security_Assessment_Report_v1_0.pdf) ⭐ 5,770 | 🐛 249 | 🌐 Rust | 📅 2026-09-10
...
* [NodeDB](https://github.com/Zacholme7/NodeDB) ⭐ 46 | 🐛 0 | 🌐 Rust | 📅 2025-05-26, updates [revm](https://github.com/bluealloy/revm) ⭐ 2,229 | 🐛 90 | 🌐 Rust | 📅 2026-09-10's database directly from Reth's database
...
* [pevm](https://github.com/risechain/pevm) ⭐ 356 | 🐛 75 | 🌐 Rust | 📅 2026-08-05, a massively-parallelised EVM implementation by [RISE Labs](https://www.riselabs.xyz) that is explicitly compatible with Reth ([blog post](https://medium.com/@rise_chain/rise-pevm-parallel-evm-bdfc4bc9f38e), [Tweet](https://x.com/gakonst/status/1798165192460976195))
...
* [openvm-reth-benchmark](https://github.com/axiom-crypto/openvm-reth-benchmark) ⭐ 17 | 🐛 11 | 🌐 Rust | 📅 2026-09-10, a set of benchmarks for Reth within the OpenVM framework
