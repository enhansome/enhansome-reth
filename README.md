...
* [Repository](https://github.com/paradigmxyz/reth) ⭐ 5,790 | 🐛 286 | 🌐 Rust | 📅 2026-09-26
...
* [Sigma Prime](https://github.com/paradigmxyz/reth/blob/0a49d47dc33058cafe5d3decfce85a3a81de62f9/Sigma_Prime_Paradigm_Reth_Security_Assessment_Report_v1_0.pdf) ⭐ 5,790 | 🐛 286 | 🌐 Rust | 📅 2026-09-26
...
* [NodeDB](https://github.com/Zacholme7/NodeDB) ⭐ 46 | 🐛 0 | 🌐 Rust | 📅 2025-05-26, updates [revm](https://github.com/bluealloy/revm) ⭐ 2,244 | 🐛 98 | 🌐 Rust | 📅 2026-09-26's database directly from Reth's database
...
* [seismic-reth](https://github.com/SeismicSystems/seismic-reth) ⭐ 143 | 🐛 52 | 🌐 Rust | 📅 2026-09-25, node software for [Seismic](https://www.seismic.systems), the encrypted blockchain
