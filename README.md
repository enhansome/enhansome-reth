...
* [Repository](https://github.com/paradigmxyz/reth) ⭐ 5,770 | 🐛 276 | 🌐 Rust | 📅 2026-09-16
...
* [Sigma Prime](https://github.com/paradigmxyz/reth/blob/0a49d47dc33058cafe5d3decfce85a3a81de62f9/Sigma_Prime_Paradigm_Reth_Security_Assessment_Report_v1_0.pdf) ⭐ 5,770 | 🐛 276 | 🌐 Rust | 📅 2026-09-16
...
* [NodeDB](https://github.com/Zacholme7/NodeDB) ⭐ 46 | 🐛 0 | 🌐 Rust | 📅 2025-05-26, updates [revm](https://github.com/bluealloy/revm) ⭐ 2,239 | 🐛 95 | 🌐 Rust | 📅 2026-09-16's database directly from Reth's database
...
* [reth-exex-examples](https://github.com/paradigmxyz/reth-exex-examples) ⭐ 166 | 🐛 13 | 🌐 Rust | 📅 2026-04-29, an official repository of example ExEx implementations
...
* [seismic-reth](https://github.com/SeismicSystems/seismic-reth) ⭐ 143 | 🐛 56 | 🌐 Rust | 📅 2026-09-16, node software for [Seismic](https://www.seismic.systems), the encrypted blockchain
...
* [openvm-reth-benchmark](https://github.com/axiom-crypto/openvm-reth-benchmark) ⭐ 17 | 🐛 10 | 🌐 Rust | 📅 2026-09-15, a set of benchmarks for Reth within the OpenVM framework
